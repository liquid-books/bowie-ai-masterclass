...
Microsoft's own documentation identifies specific best practices for optimizing the Word-to-PowerPoint workflow. These are not suggestions — they are the technical practices that determine how effectively Copilot can interpret and convert your document.
...
* - Dimension
  - Copilot in PowerPoint (chat / Agent Mode)
  - Copilot Cowork
* - **What you get back**
...
* - **Best for**
  - Building or refining a single presentation while you are in it
...
## 10. The Verification and Design Review Discipline
...
Once Copilot is ready, provide the reference to your Word document (using the file picker in the chat if available, or by describing its content if direct referencing is not yet available in your version). Confirm the instruction to create the presentation.
...
- 🤖 Create a Presentation with Copilot in PowerPoint (Microsoft Support): [support.microsoft.com — Copilot in PowerPoint](https://support.microsoft.com/en-us/office/create-a-new-presentation-with-copilot-in-powerpoint-3222ee03-f5a4-4d27-8642-9c387ab4854d)
- 📖 Copilot in PowerPoint Help & Learning: [support.microsoft.com/powerpoint-copilot](https://support.microsoft.com/en-us/copilot-powerpoint)
