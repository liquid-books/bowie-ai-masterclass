...
subtitle: "Leading and Sustaining AI Transformation Inside GES"
short_title: "Change Management"
description: "How an individual mindset shift becomes an organizational movement. Frameworks for managing resistance, championing adoption, and designing change at the team, show-team, and facility level — applied to the GES operational context across 24 global facilities and 75+ countries."
label: ch-03-change-management
tags: [change management, AI adoption, Kotter, ADKAR, champions, GES, leadership, transformation, Copilot Cowork, T.R.U.E. values]
---

```{admonition} Download this Chapter as PDF
:class: tip

[Download PDF](https://github.com/liquid-books/ges-learns-ai/raw/main/pdfs/ch03-change-management.pdf)
```
...
:alt: Illustrated infographic showing a single mindset shift at the center radiating outward through team, show floor, facility, and enterprise levels — like ripples in water — representing AI transformation spreading organically through GES
:width: 80%
:align: center

One person's mindset shift becomes a show team's new normal, which becomes a facility's standard practice, which becomes a global organization's competitive advantage. Change radiates. It does not cascade.
:::
...
## 1. The Burning Platform We Actually Have — Independence
...
Kotter's first step in organizational change is *create a sense of urgency*. Most companies fake it. Ours is real, and it is dated: **December 31, 2024**.

There is a window that opens when a company becomes independent. New ownership expects transformation. Leadership has room to make decisions that would have been deferred. Teams are already primed for change because change already happened *to* them. The organizational immune system that normally rejects new ways of working is, temporarily, more permissive.

That window does not stay open forever. Within a few years, new habits harden into the new status quo — and whatever we did *not* rebuild during the window becomes "just how GES does it" for another decade.

AI adoption belongs inside that window. Not after it.
:::
...
:::{admonition} The Proof Point We Already Own — onPeak AI Smart Suite
:class: note

In 2026, **onPeak** — part of the GES Collective, under **Lisa Baez, EVP of Tech-Enabled Services**, with **Tayler Gilmartin** leading product — launched the **AI Smart Suite**: AI-powered hotel search, an AI contract reader, and AI email categorization.

Read those three capabilities again, because none of them are exotic. A contract reader reads contracts. Email categorization sorts email. Search finds things. These are not moonshots. They are ordinary operational pain points that somebody inside GES decided to stop tolerating.

That matters enormously for change management, for one reason: **it removes the "that wouldn't work here" objection.** It already worked here. Not at a competitor. Not in a McKinsey case study. Inside the GES Collective, with GES data, GES customers, and GES constraints.

Every change program needs a first domino that the organization can point to. onPeak is ours. Use it. When someone in show operations says *"AI is for tech companies,"* the answer is not a statistic. It is: *"onPeak shipped it last year. Let me show you."*
:::
...
:alt: Three clean framework diagrams side by side — Kotter's 8-step staircase, ADKAR's five building blocks, and Bridges' Transitions Model showing the neutral zone — each with GES AI adoption annotations
:width: 80%
:align: center
...
```{list-table} Kotter's 8 Steps — Applied to GES AI Adoption
:header-rows: 1
...
**Phase 1: Endings.** Before anyone can fully commit to the new way, they have to grieve the old way. The colleague who was *the* person who knew how to build the labor forecast model — who people came to, who was recognized for that skill across three regions — is losing something when AI drafts that forecast in two minutes. That loss is real. Acknowledging it, rather than skipping past it with enthusiasm about the future, is what makes the transition human and sustainable. This is **Understanding** in the T.R.U.E. values, applied to change itself: people come first.

**Phase 2: The Neutral Zone.** The old way is over and the new way is not yet fully real. People are in between. They know the old workflow, but it feels outdated. They are learning the new workflow, but they are not yet confident in it under show pressure. This is the most uncomfortable phase — and it is also where the most creative energy lives. The Neutral Zone is where people figure out what the new way actually looks like in their specific context: a warehouse in Reno is not a design studio in London is not an exhibitor services desk at ExCeL. It cannot be rushed.

**Phase 3: New Beginnings.** The new way becomes the default. The AI-assisted workflow is not the "AI workflow" anymore — it is just how a show gets built. The beginning is complete when no one thinks of it as a transition anymore.
...
:alt: Five organizational failure modes that kill AI adoption programs at global service companies
:width: 80%
:align: center

The five failure modes that consistently derail AI adoption at operationally intensive service organizations — each preventable with the right organizational design.
:::
...
The organization deploys the tool, runs a training webinar, and considers adoption complete. No one asks: *"What specific workflows are we redesigning?"* The tool becomes optional. The exhibitor service kit is still assembled the way it was in 2015. The ROI doesn't materialize.
...
## 5. Finding and Fueling the AI Champions
...
:alt: Illustrated visual showing the AI Champion profile — a professional at the intersection of three qualities: credible with peers, curious about technology, and willing to share failures as openly as wins — surrounded by ripple effects flowing outward through their show team and facility
:width: 80%
:align: center
...
### Champions Must Span the Whole Company, Not Just Corporate
...
:alt: Communication patterns that build trust during AI adoption at a global services company
:width: 80%
:align: center

Effective AI change communication flows from executive leadership through managers and champions to every employee — on the show floor, in the warehouse, and at the desk — with feedback loops built in at every level.
:::
...
**Weak delegation:** *"Do the post-show reconciliation."*

**Strong delegation:** *"Using the labor actuals workbook in the show's SharePoint folder and the original labor forecast, produce a reconciliation summary that lists every line where actual hours exceeded forecast by more than 10%, groups the variances by trade and by day, drafts a one-page narrative explaining the top three drivers, and flags anything you could not verify from the source files. Do not estimate missing values — list them as gaps."*

The second version tells Cowork what "done" means, where the truth lives, and — critically — what to do when it doesn't know something. That last instruction is the one people forget, and it is the one that protects you.
::::
...
- Who reviews Cowork output before it reaches an exhibitor, an organizer, or an agency partner?
- Does an internal artifact need the same review as an external one? (No — but say so explicitly, or people will either over-review everything or under-review everything.)
- How do we mark a document as AI-executed so a reviewer knows what to check?
- What is the standard for verifying the *inputs* Cowork used, not just the output it produced?
- Where does accountability sit? (Always with the human who delegated. Always. **Responsibility** in T.R.U.E. is non-transferable — a tool cannot own an outcome.)

:::{admonition} A Practical Review Standard for Cowork Output
:class: note

Adopt this as a team norm and write it down somewhere people will actually see it:

1. **Trace the sources.** Before reviewing the output, check which files, threads, and data it drew from. Wrong inputs produce confidently wrong outputs.
2. **Spot-check the numbers.** Verify at least three figures against source. If any fail, review the entire output, not just that figure.
...
4. **Own it before you send it.** The person who delegated the task is the person whose judgment is on the document. Nothing goes to a client, an organizer, or an exhibitor without a named human who has read it end to end.
5. **Log the pattern.** If Cowork got something wrong in a way it is likely to repeat, capture that in your team's shared notes so the next person doesn't rediscover it.
:::
...
Whoever launches Cowork to a GES team — a facility GM, a regional lead, a function head — should say this out loud, in plain language, in the first five minutes:

> *"Yes, this is metered. Yes, we have budgeted for it. Using it on real work is exactly what the budget is for. If you hit your limit doing legitimate work, that is information we want, not a mistake you made."*

Without that sentence, half the team will quietly avoid the tool and never tell you why.
::::
...
- **Months 1–3:** Copilot Chat across all populations. Build the habit. Establish verification discipline. Identify Champions.
- **Months 4–5:** Cowork pilot with Champions only — 8–12 people across show ops, creative, logistics, sales, and corporate. Real workflows, tracked outcomes, tracked credit consumption. Build the review norms *from what actually happens*, not from theory.
- **Month 6+:** Expand Cowork to teams whose workflows the pilot proved out, with the governance guardrails and the review standard already written and socialized.
...
- **Week 1:** Leader communication — personal, specific, and modeling-focused. Not a strategy announcement — a genuine *"I tried this and here's what I found"* message from the most credible voice available in your part of the business. Tie it to independence: we control our own roadmap now.
- **Week 2:** Identify Champions. Three to five volunteers across different functions and seniority levels — and make sure at least two of them do not sit at a desk. Give them access, protected time, and a clear mandate: experiment and share.
- **Week 3:** First "AI Lab" session — informal, one hour, hybrid so remote and on-site people can join, recorded for the crews who are mid-build. Champions demonstrate something real. No slides, no certification. Just: *"Here's what I tried on last week's show. Here's what happened. Here's what you can try today."*
- **Week 4:** Open channel — a Teams channel, a Viva Engage group, a SharePoint page — where people can share AI experiments, tips, and questions. Seed it with Champion contributions. Make sharing feel low-stakes. Make sure it is reachable on a phone, because half your audience will only ever see it on a phone.
...
- **Week 5–6:** Champions each identify one repeatable workflow in their area and redesign it with AI assistance. Not a demo — a real workflow the team actually uses on a real show. Good candidates: exhibitor service kit assembly, daily move-in status reporting, labor forecast-to-actuals variance narrative, organizer RFP response first draft, post-show recap deck, site survey notes to venue knowledge base.
- **Week 7:** First internal "what's working" session. Champions present: *"We changed how we do X. Here is what it looked like before. Here is what it looks like now. Here is the time saved / errors avoided / quality improved."* Numbers matter here — hours, error rates, turnaround times.
- **Week 8:** Expand access, and open the **Cowork pilot** with your Champion group if Chat habits are established. Set the credit budget and the review norms before anyone starts, not after.
...
- **Week 9–10:** Document the redesigned workflows as standard operating procedures. Put them where show teams actually look: the show ops manual, the facility SharePoint, the crew lead checklist, the onboarding path. Make AI-assisted practice the baseline expectation for new hires.
- **Week 11–12:** First Showcase event — internal, celebrated, visible, and **cross-facility**. Invite Las Vegas, Chicago, Toronto, London, Amsterdam, and Dubai. This is your direct countermeasure to Failure Mode 5. A workflow improvement that only one facility knows about is a rounding error; the same improvement adopted across 24 facilities is a company-level result.
- **Week 13–14:** Review what the 100 days revealed. What worked? What stalled? Who surprised you? What did the Cowork pilot teach you about budget, review norms, and where delegation genuinely pays? What should the next 100 days look like?
...
3. Place each member of your team (by first name or initials) in the quadrant that best reflects where they are *today*. Include your non-desk team members — crew leads, warehouse staff, on-site coordinators. If you cannot place them, that itself is a finding.
...
1. Navigate to [m365.cloud.microsoft](https://m365.cloud.microsoft) → Copilot Chat. Sign in with your GES Microsoft 365 credentials. Confirm the green enterprise shield is visible in the top right of the interface.
2. Paste this prompt, filling in your specifics:

> *"I am a [your role] at GES, a global general service contractor and experiential marketing company that delivers 4,000+ live events a year across 75+ countries, with 24 production and warehouse facilities. I am responsible for leading AI adoption in my team. I have [number] direct reports, and [number] of them work on show floors or in warehouses rather than at a desk. Play the role of a highly experienced organizational change management consultant who has led AI adoption programs in distributed, operations-intensive service businesses. Be direct. Challenge my assumptions. Don't tell me what I want to hear. Here is my situation: [describe your team, their current AI adoption state, and the one or two biggest obstacles you see]."*

3. Engage in at least five back-and-forth exchanges. Push back when something doesn't feel right for your context — especially if the advice assumes everyone sits at a desk. Ask for specific tactics, not just frameworks.
...
2. Title it: *GES AI Adoption — 90-Day Plan — [Your Name] — [Date]*.
3. Create five sections:

   **Champions:** Name your 2–3 identified Champions — at least one from outside the office. What is your action with each in the next two weeks?

   **First Win:** What is the single workflow you will redesign with AI in the next 30 days? Name the workflow (exhibitor service kit, move-in status report, labor variance narrative, RFP first draft, post-show recap), the show or account you'll test it on, the team members involved, and the metric you will track.

   **Reaching the Field:** How will this reach the people on your team who don't work at a desk? Name the existing meeting or rhythm you'll use. If your answer is "an email," start again.

   **Communication:** What will you say, and when, to your team about AI in the next 30 days? Write one sentence that captures your message — and connect it to what independence makes possible.

   **Governance Clarity:** What questions do you need answered by IT, Legal, or Finance to enable safe AI experimentation — including the Cowork credit budget for your team? List them. Then schedule the conversation to get them answered.

4. Share this document with your manager as a discussion agenda for your next 1:1.

**What you are building:** A concrete, personal change management plan that moves AI adoption from conversation to calendar. The professionals who do this exercise leave the program with something that actually gets implemented. The ones who skip it take home good ideas that fade under the pressure of the next move-in.
::::

---

::::{admonition} Exercise 4: Draft Your Team's Cowork Delegation Standard
:class: tip
...
1. Open Microsoft Word → New Document. Title it: *[Your Team] — Cowork Delegation & Review Standard — v0.1*.
2. Write four short sections. Keep the whole thing to one page — a standard nobody reads is not a standard.

   **What we delegate:** List 3–5 multi-step tasks in your area worth handing to Cowork end-to-end. Be specific. "Post-show labor reconciliation summary" — not "reporting."

   **What we don't delegate:** List what stays human or stays in Copilot Chat. Include anything in your Red tier — attendee PII, customs documentation, union agreement interpretation, safety-critical instructions.

   **How we brief:** Write your team's template for a Cowork task. It should always name the source files, define what "done" looks like, and instruct Cowork to flag anything it could not verify rather than estimate it.

   **How we review:** Adopt or adapt the five-step review standard from Section 7. Name who reviews what before it leaves GES.

3. Add one line at the top: *"The person who delegates the task owns the output. Always."*
4. Share it with your team and revise it after two weeks of real use. Version 0.1 is supposed to be wrong in places — that's why it has a version number.

**What you are building:** The review and delegation norms that determine whether Cowork becomes a genuine capability or a governance incident. Teams that write this down in advance adopt faster, because their people are not guessing about what's allowed.
::::
...
**Step 1 — Distribute individually.** Send the questionnaire to your team before a team meeting or session. Anonymous responses are fine — and often more honest. Give people 10 minutes to complete it on their own, in private. Make sure it works on a phone; a meaningful share of your team will only ever open it that way.

**Step 2 — Present the aggregate results.** In your session, share the thematic patterns — not individual responses. "Four people said post-show reconciliation is our biggest bottleneck." "Most of us rated our AI skill at 4 or 5 out of 10." This creates a shared reality without exposing individuals.
...
Tally question 3 responses. Plot your team on the maturity scale. What is the median? What is the range? Are most people at Level 2 (Curious) or Level 3 (Functional)? This tells you the appropriate starting point for your 100-day plan — and whether a Cowork pilot is premature.

**Step 2 — Surface the Perception Gap (5 min)**
Compare question 6 and 7 responses to what you know to be true as a leader. If people perceive lower capability or weaker strategy than you know exists — for instance, if nobody mentions onPeak's AI Smart Suite — you have a communication gap. That is a leadership action item, not a training action item.

**Step 3 — Map the Pain Points (15 min)**
Read all responses to question 10. Highlight recurring themes. Write each unique workflow on a sticky note or slide. Group them. The clusters that emerge — especially those appearing across multiple roles and multiple facilities — are your pilot candidates.
...
Plot your top 3-5 opportunities on a simple 2×2: Impact (High/Low) vs. Feasibility (High/Low). Start with High Impact, High Feasibility — these are your Day 1-30 pilots in the 100-day playbook. Add a third informal filter: *does this travel?* A high-impact fix that only works in one venue is worth less than a moderate fix that works in twenty-four facilities.
:::
...
1. GES has a real burning platform, not a manufactured one: independence from Viad on December 31, 2024, after 55 years. We control our own roadmap for the first time in decades — and that window closes.
2. The organizations capturing AI returns redesigned their workflows. Technology adoption without workflow redesign produces minimal results.
3. Change fails for five specific reasons — all of them organizational, none of them technical. At GES, Failure Mode 5 (Showcase Without Scale) is the biggest risk, because good ideas have to travel across 24 facilities and 75+ countries.
4. Kotter provides the staircase, ADKAR provides the individual journey, Bridges provides the emotional truth. Use all three.
5. AI Champions should be credible peers, not tech specialists — and at least half of them must come from outside the office. Find them. Equip them. Give them protected time and a platform.
6. The four resistance archetypes require four different leadership moves. One intervention doesn't work for all four.
7. Copilot Cowork is a bigger behavioral change than chat-based Copilot: it requires delegation skills, explicit new review and approval norms, and usage-based budget guardrails communicated before rollout, not after the first invoice.
8. Change management must reach the non-desk workforce — show ops, I&D crews, warehouse and logistics teams — through mobile-first materials, existing show rhythms, and translated content.
9. Communication patterns determine whether people feel AI is happening to them or for them — leaders own that, and visible modeling by named leaders beats any memo.
10. The 100-day playbook: 30 days of awareness, 30 days of pilots, 40 days of scale — with the Showcase run cross-facility, not locally.
11. Governance should be proportional to risk. Green, Amber, Red. Go with guardrails — not wait with approval.
12. onPeak's AI Smart Suite is proof this works inside GES already. Use it as the first domino.
:::
...
- 🏢 The GES Collective — GES Exhibitions, Spiro, onPeak, SHOWTECH, Visit by GES
:::
...
```{glossary}
AI Champion
  A credible, curious, and publicly-learning professional who models AI adoption within their team, show crew, or facility — making it safe for others to experiment by sharing both successes and failures.
...
Proportional Governance
  The principle that AI governance intensity should match the risk level of the specific use case — applying full review rigor to high-risk workflows (attendee PII, customs and carnet documentation, union agreement interpretation, published ESG data) while providing a fast lane for inherently low-risk AI use.

Floor Captain Model
  An AI adoption approach in which identified enthusiasts are available within each facility, department, or show crew to demonstrate, support, and celebrate colleagues' AI experiments without a formal training mandate. Maps naturally onto GES's facility and show-team structure.
...
Copilot Credits
  The consumption unit used to meter Copilot Cowork usage. Because cost varies with how much work is delegated, organizations need named budget owners, stated allowances, and visible consumption reporting to prevent both fear-driven under-use and uncontrolled burn.

Delegation Standard
  A short, written team norm defining which multi-step tasks are handed to an AI agent end-to-end, which are not, how tasks are briefed (sources, definition of done, instruction to flag unverifiable items), and who reviews the output before it leaves the organization.

T.R.U.E. Values
  GES's core values — Trust, Responsibility, Understanding, Excellence — which map directly onto responsible AI practice: verify honestly, own the output, put people first through the transition, and let AI raise the floor while people raise the ceiling.
```
